...
Editor-only infinite reference grid rendered on the world XZ plane as a screen-space pass over the final scene color. Provides spatial grounding for scene authoring without imposing a fixed-size ground quad.
