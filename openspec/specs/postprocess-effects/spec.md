...
Data-driven postprocess effects: each effect is a JSON descriptor plus an external GLSL fullscreen-quad shader, loaded without engine changes and executed as chained passes with ping-ponged intermediate buffers. Ships ACES tonemapping, FXAA, and retro CRT samples.
