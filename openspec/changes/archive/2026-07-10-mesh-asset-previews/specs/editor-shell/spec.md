...
#### Scenario: Mesh tile shows a white-box Lambert render
...
- **THEN** the tile's thumbnail is a 128×128 render of the Cube mesh with the white-box Lambert shader (flat 0.7 grey albedo, fixed directional light, white background)
